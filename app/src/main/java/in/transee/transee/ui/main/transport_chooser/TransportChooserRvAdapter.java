 ...
 */
public class TransportChooserRvAdapter
        extends RecyclerView.Adapter<TransportChooserRvAdapter.TransportChooserVH> {
    ...
    @Override
    public TransportChooserVH onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater
                .from(parent.getContext())
                .inflate(R.layout.list_item_transport_chooser, parent, false);
        return new TransportChooserVH(v, multiSelector);
    }

    @Override
    public void onBindViewHolder(TransportChooserVH holder, int position) {
    ...
    class TransportChooserVH extends SwappingHolder implements View.OnClickListener {

        private ImageView transportIcon;
        private TextView transportName;

        public TransportChooserVH(View itemView, MultiSelector multiSelector) {
